...
var Royal_Preloader = {
    ...
    _text_colour: function() {
        return "undefined" !== typeof Royal_Preloader && "undefined" !== typeof Royal_Preloader._text_colour ? Royal_Preloader._text_colour : "#FFFFFF"
    }(),
    _images: function() {
    ...
    _show_progress: function() {
        return "undefined" !== typeof Royal_Preloader && "undefined" !== typeof Royal_Preloader._show_progress ? Royal_Preloader._show_progress : !0
    }(),
    _show_percentage: function() {
        return "undefined" !==
            typeof Royal_Preloader && "undefined" !== typeof Royal_Preloader._show_percentage ? Royal_Preloader._show_percentage : !0
    }(),
    ...
    _logo: function() {
        return "undefined" !== typeof Royal_Preloader && "undefined" !== typeof Royal_Preloader._logo ? Royal_Preloader._logo : ""
    }(),
    _logo_size: function() {
        return "undefined" !== typeof Royal_Preloader && "undefined" !== typeof Royal_Preloader._logo_size ?
            Royal_Preloader._logo_size : [80, 80]
    }(),
    _cookie: function() {
        return "undefined" !== typeof Royal_Preloader && "undefined" !== typeof Royal_Preloader._cookie ? Royal_Preloader._cookie : !1
    }(),
    _timeout: function() {
        return "undefined" !== typeof Royal_Preloader && "undefined" !== typeof Royal_Preloader._timeout ? Royal_Preloader._timeout : 10
    }(),
    _init: function() {
        ...
        switch (this._mode) {
            ...
            case "progress":
                this._progress_loader = JQ("<div>").addClass("royal_preloader_loader").appendTo(this._overlay),
                    this._progress_loader_meter = JQ("<div>").addClass("royal_preloader_meter").appendTo(this._progress_loader), this._show_progress && (this._percentage = JQ("<div>").addClass("royal_preloader_percentage").text(0).appendTo(this._overlay))
        }
        this._overlay.appendTo(JQ(document.body));
        "text" === this._mode && this._text_loader.css("margin-left", this._text_loader.width() / 2 * -1)
    },
    _load: function() {
        "number" !== this._mode && "logo" !== this._mode && "progress" !== this._mode || !this._show_progress || (this._percentage.data("num", 0),
    ...
    _processQueue: function() {
        0 !== this._image_queue.length && (this._loaded++, Royal_Preloader._animatePercentage(Royal_Preloader._percentage_loaded, parseInt(this._loaded /
            this._total * 100, 10)), this._reQueue())
    },
